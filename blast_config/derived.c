...
derived_tng_t derived_list[] = {
    ...
    BITWORD("DISABLE_EL", "veto_sensor", 11, 1),
    BITWORD("DISABLE_AZ", "veto_sensor", 12, 1),
    BITWORD("FORCE_EL", "veto_sensor", 13, 1),
    BITWORD("VETO_PSS", "veto_sensor", 14, 1),
    BITWORD("VETO_DGPS", "veto_sensor", 15, 1),
    ...
    BITWORD("LATCHED_MASK_DATA_CRC_EL", "latched_fault_mask_el", 0, 1),
    BITWORD("LATCHED_MASK_AMP_INT_EL", "latched_fault_mask_el", 1, 1),
    BITWORD("LATCHED_MASK_SHORT_CIRC_EL", "latched_fault_mask_el", 2, 1),
    BITWORD("LATCHED_MASK_AMP_OVER_T_EL", "latched_fault_mask_el", 3, 1),
    BITWORD("LATCHED_MASK_MOTOR_OVER_T_EL", "latched_fault_mask_el", 4, 1),
    BITWORD("LATCHED_MASK_OVERVOLT_EL", "latched_fault_mask_el", 5, 1),
    BITWORD("LATCHED_MASK_UNDERVOLT_EL", "latched_fault_mask_el", 6, 1),
    BITWORD("LATCHED_MASK_FEEDBACK_EL", "latched_fault_mask_el", 7, 1),
    BITWORD("LATCHED_MASK_PHASING_ERR_EL", "latched_fault_mask_el", 8, 1),
    BITWORD("LATCHED_MASK_TRACKING_ERR_EL", "latched_fault_mask_el", 9, 1),
    BITWORD("LATCHED_MASK_OVERCURRENT_EL", "latched_fault_mask_el", 10, 1),
    BITWORD("LATCHED_MASK_FPGA_FAIL_EL", "latched_fault_mask_el", 11, 1),
    BITWORD("LATCHED_MASK_CMD_INPUT_LOST_EL", "latched_fault_mask_el", 12, 1),
    BITWORD("LATCHED_MASK_FPGA_FAIL2_EL", "latched_fault_mask_el", 13, 1),
    BITWORD("LATCHED_MASK_SAFETY_CIRC_EL", "latched_fault_mask_el", 14, 1),
    BITWORD("LATCHED_MASK_CONT_CURRENT_EL", "latched_fault_mask_el", 15, 1),
    BITWORD("LATCHED_MASK_MOTOR_WIRING_DISCON_EL", "latched_fault_mask_el", 16, 1),
    BITWORD("LATCHED_MASK_STO_ACTIVE_EL", "latched_fault_mask_el", 18, 1),
    ...
    BITWORD("LATCHED_MASK_DATA_CRC_PIV", "latched_fault_mask_piv", 0, 1),
    BITWORD("LATCHED_MASK_AMP_INT_PIV", "latched_fault_mask_piv", 1, 1),
    BITWORD("LATCHED_MASK_SHORT_CIRC_PIV", "latched_fault_mask_piv", 2, 1),
    BITWORD("LATCHED_MASK_AMP_OVER_T_PIV", "latched_fault_mask_piv", 3, 1),
    BITWORD("LATCHED_MASK_MOTOR_OVER_T_PIV", "latched_fault_mask_piv", 4, 1),
    BITWORD("LATCHED_MASK_OVERVOLT_PIV", "latched_fault_mask_piv", 5, 1),
    BITWORD("LATCHED_MASK_UNDERVOLT_PIV", "latched_fault_mask_piv", 6, 1),
    BITWORD("LATCHED_MASK_FEEDBACK_PIV", "latched_fault_mask_piv", 7, 1),
    BITWORD("LATCHED_MASK_PHASING_ERR_PIV", "latched_fault_mask_piv", 8, 1),
    BITWORD("LATCHED_MASK_TRACKING_ERR_PIV", "latched_fault_mask_piv", 9, 1),
    BITWORD("LATCHED_MASK_OVERCURRENT_PIV", "latched_fault_mask_piv", 10, 1),
    BITWORD("LATCHED_MASK_FPGA_FAIL_PIV", "latched_fault_mask_piv", 11, 1),
    BITWORD("LATCHED_MASK_CMD_INPUT_LOST_PIV", "latched_fault_mask_piv", 12, 1),
    BITWORD("LATCHED_MASK_FPGA_FAIL2_PIV", "latched_fault_mask_piv", 13, 1),
    BITWORD("LATCHED_MASK_SAFETY_CIRC_PIV", "latched_fault_mask_piv", 14, 1),
    BITWORD("LATCHED_MASK_CONT_CURRENT_PIV", "latched_fault_mask_piv", 15, 1),
    BITWORD("LATCHED_MASK_MOTOR_WIRING_DISCON_PIV", "latched_fault_mask_piv", 16, 1),
    BITWORD("LATCHED_MASK_STO_ACTIVE_PIV", "latched_fault_mask_piv", 18, 1),
    ...
    BITWORD("LATCHED_MASK_DATA_CRC_RW", "latched_fault_mask_rw", 0, 1),
    BITWORD("LATCHED_MASK_AMP_INT_RW", "latched_fault_mask_rw", 1, 1),
    BITWORD("LATCHED_MASK_SHORT_CIRC_RW", "latched_fault_mask_rw", 2, 1),
    BITWORD("LATCHED_MASK_AMP_OVER_T_RW", "latched_fault_mask_rw", 3, 1),
    BITWORD("LATCHED_MASK_MOTOR_OVER_T_RW", "latched_fault_mask_rw", 4, 1),
    BITWORD("LATCHED_MASK_OVERVOLT_RW", "latched_fault_mask_rw", 5, 1),
    BITWORD("LATCHED_MASK_UNDERVOLT_RW", "latched_fault_mask_rw", 6, 1),
    BITWORD("LATCHED_MASK_FEEDBACK_RW", "latched_fault_mask_rw", 7, 1),
    BITWORD("LATCHED_MASK_PHASING_ERR_RW", "latched_fault_mask_rw", 8, 1),
    BITWORD("LATCHED_MASK_TRACKING_ERR_RW", "latched_fault_mask_rw", 9, 1),
    BITWORD("LATCHED_MASK_OVERCURRENT_RW", "latched_fault_mask_rw", 10, 1),
    BITWORD("LATCHED_MASK_FPGA_FAIL_RW", "latched_fault_mask_rw", 11, 1),
    BITWORD("LATCHED_MASK_CMD_INPUT_LOST_RW", "latched_fault_mask_rw", 12, 1),
    BITWORD("LATCHED_MASK_FPGA_FAIL2_RW", "latched_fault_mask_rw", 13, 1),
    BITWORD("LATCHED_MASK_SAFETY_CIRC_RW", "latched_fault_mask_rw", 14, 1),
    BITWORD("LATCHED_MASK_CONT_CURRENT_RW", "latched_fault_mask_rw", 15, 1),
    BITWORD("LATCHED_MASK_MOTOR_WIRING_DISCON_RW", "latched_fault_mask_rw", 16, 1),
    BITWORD("LATCHED_MASK_STO_ACTIVE_RW", "latched_fault_mask_rw", 18, 1),
    ...
    // thermistors
    // resistances
    LINTERP("Therm1_R", "THERMISTOR_1", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm2_R", "THERMISTOR_2", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm3_R", "THERMISTOR_3", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm4_R", "THERMISTOR_4", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm5_R", "THERMISTOR_5", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm6_R", "THERMISTOR_6", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm7_R", "THERMISTOR_7", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm8_R", "THERMISTOR_8", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm9_R", "THERMISTOR_9", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm10_R", "THERMISTOR_10", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm11_R", "THERMISTOR_11", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm12_R", "THERMISTOR_12", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm13_R", "THERMISTOR_13", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm14_R", "THERMISTOR_14", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm15_R", "THERMISTOR_15", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm16_R", "THERMISTOR_16", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm17_R", "THERMISTOR_17", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm18_R", "THERMISTOR_18", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm19_R", "THERMISTOR_19", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm20_R", "THERMISTOR_20", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm21_R", "THERMISTOR_21", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm22_R", "THERMISTOR_22", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm23_R", "THERMISTOR_23", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm24_R", "THERMISTOR_24", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm25_R", "THERMISTOR_25", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm26_R", "THERMISTOR_26", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm27_R", "THERMISTOR_27", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm28_R", "THERMISTOR_28", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm29_R", "THERMISTOR_29", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm30_R", "THERMISTOR_30", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm31_R", "THERMISTOR_31", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm32_R", "THERMISTOR_32", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm33_R", "THERMISTOR_33", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm34_R", "THERMISTOR_34", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm35_R", "THERMISTOR_35", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm36_R", "THERMISTOR_36", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm37_R", "THERMISTOR_37", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm38_R", "THERMISTOR_38", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm39_R", "THERMISTOR_39", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm40_R", "THERMISTOR_40", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm41_R", "THERMISTOR_41", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm42_R", "THERMISTOR_42", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm43_R", "THERMISTOR_43", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm44_R", "THERMISTOR_44", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm45_R", "THERMISTOR_45", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm46_R", "THERMISTOR_46", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm47_R", "THERMISTOR_47", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm48_R", "THERMISTOR_48", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm49_R", "THERMISTOR_49", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm50_R", "THERMISTOR_50", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm51_R", "THERMISTOR_51", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm52_R", "THERMISTOR_52", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm53_R", "THERMISTOR_53", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm54_R", "THERMISTOR_54", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm55_R", "THERMISTOR_55", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm56_R", "THERMISTOR_56", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm57_R", "THERMISTOR_57", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm58_R", "THERMISTOR_58", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm59_R", "THERMISTOR_59", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm60_R", "THERMISTOR_60", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm61_R", "THERMISTOR_61", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm62_R", "THERMISTOR_62", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm63_R", "THERMISTOR_63", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm64_R", "THERMISTOR_64", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm65_R", "THERMISTOR_65", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm66_R", "THERMISTOR_66", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm67_R", "THERMISTOR_67", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm68_R", "THERMISTOR_68", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm69_R", "THERMISTOR_69", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm70_R", "THERMISTOR_70", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm71_R", "THERMISTOR_71", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm72_R", "THERMISTOR_72", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm73_R", "THERMISTOR_73", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm74_R", "THERMISTOR_74", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm75_R", "THERMISTOR_75", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm76_R", "THERMISTOR_76", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm77_R", "THERMISTOR_77", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm78_R", "THERMISTOR_78", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm79_R", "THERMISTOR_79", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm80_R", "THERMISTOR_80", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm81_R", "THERMISTOR_81", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm82_R", "THERMISTOR_82", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm83_R", "THERMISTOR_83", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    LINTERP("Therm84_R", "THERMISTOR_84", LUT_DIR "thermistor_V_to_R_TIM.lut"),
    // Temperatures
    LINTERP("Therm_T_unused_1", "Therm1_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_2", "Therm2_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_3", "Therm3_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_4", "Therm4_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_rw_mc", "Therm5_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_rw_port", "Therm6_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_fake_if_star", "Therm7_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_uc_port", "Therm8_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_uc_star", "Therm9_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sc1_comp", "Therm10_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sc1_lens", "Therm11_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sc1_ccd", "Therm12_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_if_switch", "Therm13_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_14", "Therm14_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sc1_box", "Therm15_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sc2_comp", "Therm16_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sc2_lens", "Therm17_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sc2_ccd", "Therm18_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_19", "Therm19_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sc2_box", "Therm20_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_gyro1", "Therm21_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_gyro2", "Therm22_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_23", "Therm23_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_piv_shaft", "Therm24_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_piv_mot_star", "Therm25_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_piv_mot_port", "Therm26_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_piv_mc", "Therm27_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_piv_house_bore", "Therm28_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_piv_house_anti", "Therm29_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_slip_ring", "Therm30_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_pss_plate", "Therm31_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_gps_plate", "Therm32_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_boom_mid", "Therm33_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_5way_port_in", "Therm34_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_5way_star_in", "Therm35_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_36", "Therm36_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_5way_star_between", "Therm37_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_5way_port_between", "Therm38_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_chin_mid_in", "Therm39_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_chin_mid_between", "Therm40_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_spreader_port", "Therm41_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_spreader_star", "Therm42_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sip_bore_port", "Therm43_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sip_anti_star", "Therm44_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sus_bore_star", "Therm45_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sus_anti_star", "Therm46_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_solararray_top", "Therm47_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_pbob_of_gondola", "Therm48_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_pbob_of_vicors", "Therm49_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_watchdog", "Therm50_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_pbob_mot_gondola", "Therm51_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_solarpanel_in_mid", "Therm52_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_pbob_mot_vicors", "Therm53_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_pbob_mot_relays", "Therm54_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_solarr_gond_bot", "Therm55_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_fc1_gondola", "Therm56_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_fc1_computer", "Therm57_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_fc2_gondola", "Therm58_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_fc2_computer", "Therm59_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_gps_readout", "Therm60_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sus_bore_port", "Therm61_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sus_anti_port", "Therm62_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_leg_anti_port", "Therm63_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_leg_bore_star", "Therm64_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_aframe_el_mot", "Therm65_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_aframe_bearing", "Therm66_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_lockpin", "Therm67_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_magnetometer", "Therm68_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_fake_if_port", "Therm69_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_hddpv1_port", "Therm70_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_hddpv2_star", "Therm71_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_inc1", "Therm72_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_el_mot_bore", "Therm73_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_inc2", "Therm74_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_75", "Therm75_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_el_mc", "Therm76_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_77", "Therm77_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_78", "Therm78_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_79", "Therm79_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_80", "Therm80_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_81", "Therm81_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_82", "Therm82_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_83", "Therm83_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_84", "Therm84_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
