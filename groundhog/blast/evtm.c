...
/**
 * @brief enables the infinite loop in the EVTM receiver function, can be used when testing
 * currently not used as the loop body function and the setup function are tested separately
 * but, if you did not want to do that, you could wrap this to test EVTM_udp_receive directly as a whole
 *
