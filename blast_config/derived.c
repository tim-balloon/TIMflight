...
derived_tng_t derived_list[] = {
    ...
    LINTERP("Therm_T_solarpanel_in_mid", "Therm47_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    ...
    LINTERP("Therm_T_solararray_top", "Therm52_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
