...
struct scom scommands[xyzzy + 1] = {
    ...
    {COMMAND(watchdog_on), "Turn on power to watchdog board (BYPASS WD FIRST OR IT WILL NOT WORK)",
         GR_POWER | CONFIRM},
    {COMMAND(watchdog_off), "Turn off power to watchdog board (BYPASS WD FIRST OR YOU WILL LOSE INCHARGE)",
         GR_POWER | CONFIRM},
    {COMMAND(thermistors_on), "Turn on power to thermistor box", GR_POWER},
    {COMMAND(thermistors_off), "Turn off power to thermistor box", GR_POWER},
    {COMMAND(acomp_on), "Turn on power to analysis computers", GR_POWER},
    {COMMAND(acomp_off), "Turn off power to analysis computers", GR_POWER},
    {COMMAND(motor_eth_on), "Turn on power to motor switch", GR_POWER},
    {COMMAND(motor_eth_off), "Turn off power to motor switch", GR_POWER},
    {COMMAND(magnetometer_on), "Turn on power to magnetometers", GR_POWER},
    {COMMAND(magnetometer_off), "Turn off power to magnetometers", GR_POWER},
    ...
    // IF PBOB
    {COMMAND(rfsoc1_on), "Turn on power to IF relay 2", GR_POWER},
    {COMMAND(rfsoc1_off), "Turn off power to IF relay 2", GR_POWER},
    {COMMAND(sc1_on), "Turn on power to IF relay 3", GR_POWER},
    {COMMAND(sc1_off), "Turn off power to IF relay 3", GR_POWER},
    {COMMAND(tauhk_on), "Turn on power to IF relay 4", GR_POWER},
    {COMMAND(tauhk_off), "Turn off power to IF relay 4", GR_POWER},
    {COMMAND(gyros_on), "Turn on power to IF relay 5", GR_POWER},
    {COMMAND(gyros_off), "Turn off power to IF relay 5", GR_POWER},
    {COMMAND(rfsoc2_on), "Turn on power to IF relay 6", GR_POWER},
    {COMMAND(rfsoc2_off), "Turn off power to IF relay 6", GR_POWER},
    {COMMAND(inclinometer_on), "Turn on power to IF relay 7", GR_POWER},
    {COMMAND(inclinometer_off), "Turn off power to IF relay 7", GR_POWER},
    {COMMAND(sc2_on), "Turn on power to IF relay 8", GR_POWER},
    {COMMAND(sc2_off), "Turn off power to IF relay 8", GR_POWER},
    {COMMAND(act_bus_on), "Turn on power to IF relay 9", GR_POWER},
    {COMMAND(act_bus_off), "Turn off power to IF relay 9", GR_POWER},
    ...
    // motor PBOB
    {COMMAND(starlink_on), "Turn on power to starlink antenna", GR_POWER},
    {COMMAND(starlink_off), "Turn off power to starlink antenna (SWAP COMMAND CHANNEL)", GR_POWER | CONFIRM},
    ...
    // not recommended to use more power on motor pbob because power draw already very high! (>400 W)
