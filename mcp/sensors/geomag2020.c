 ...
 */
{
    switch(control) {
        case 1:
            blast_err("Error allocating in MAG_LegendreFunctionMemory.");
            break;
        case 2:
            blast_err("Error allocating in MAG_AllocateModelMemory.");
            break;
        case 3:
            blast_err("Error allocating in MAG_InitializeGeoid");
            break;
        case 4:
            blast_err("Error in setting default values.");
            break;
        case 5:
            blast_err("Error initializing Geoid.");
            break;
        case 6:
            blast_err("Error opening WMM.COF.");
            break;
        case 7:
            blast_err("Error opening WMMSV.COF.");
            break;
        case 8:
            blast_err("Error reading Magnetic Model.");
            break;
        case 9:
            blast_err("Error printing Command Prompt introduction.");
            break;
        case 10:
            blast_err("Error converting from geodetic co-ordinates to spherical co-ordinates.");
            break;
        case 11:
            blast_err("Error in time modifying the Magnetic model");
            break;
        case 12:
            blast_err("Error in Geomagnetic");
            break;
        case 13:
            blast_err("Error printing user data");\
			break;
        case 14:
            blast_err("Error allocating in MAG_SummationSpecial");
            break;
        case 15:
            blast_err("Error allocating in MAG_SecVarSummationSpecial");
            break;
        case 16:
            blast_err("Error in opening EGM9615.BIN file");
            break;
        case 17:
            blast_err("Error: Latitude OR Longitude out of range in MAG_GetGeoidHeight");
            break;
        case 18:
            blast_err("Error allocating in MAG_PcupHigh");
            break;
        case 19:
            blast_err("Error allocating in MAG_PcupLow");
            break;
        case 20:
            blast_err("Error opening coefficient file");
            break;
        case 21:
            blast_err("Error: UnitDepth too large");
            break;
        case 22:
            blast_err("Your system needs Big endian version of EGM9615.BIN.  ");
            blast_err("Please download this file from http://www.ngdc.noaa.gov/geomag/WMM/DoDWMM.shtml.  ");
            blast_err("Replace the existing EGM9615.BIN file with the downloaded one");
            break;
    }
} /*MAG_Error*/
