...
channel_t channel_list[] =
{
    ...
    { "status_if_inc",           SCALE(CONVERT_UNITY),   TYPE_UINT8, RATE_1HZ, U_NONE, 0 },
    { "err_count_if_inc",        SCALE(CONVERT_UNITY),   TYPE_UINT16, RATE_1HZ, U_NONE, 0 },
    { "timeout_count_if_inc",    SCALE(CONVERT_UNITY),   TYPE_UINT16, RATE_1HZ, U_NONE, 0 },
    { "reset_count_if_inc",      SCALE(CONVERT_UNITY),   TYPE_UINT16, RATE_1HZ, U_NONE, 0 },

    { "inc_of_x",                1,              0,  TYPE_FLOAT, RATE_100HZ, U_NONE, 0 },
    { "inc_of_y",                1,              0,  TYPE_FLOAT, RATE_100HZ, U_NONE, 0 },
    { "inc_of_temp",             1,              0,  TYPE_FLOAT, RATE_100HZ, U_NONE, 0 },

    { "status_of_inc",           SCALE(CONVERT_UNITY),   TYPE_UINT8, RATE_1HZ, U_NONE, 0 },
    { "err_count_of_inc",        SCALE(CONVERT_UNITY),   TYPE_UINT16, RATE_1HZ, U_NONE, 0 },
    { "timeout_count_of_inc",    SCALE(CONVERT_UNITY),   TYPE_UINT16, RATE_1HZ, U_NONE, 0 },
    { "reset_count_of_inc",      SCALE(CONVERT_UNITY),   TYPE_UINT16, RATE_1HZ, U_NONE, 0 },
