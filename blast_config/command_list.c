...
struct scom scommands[xyzzy + 1] = {
    ...
    {COMMAND(of_inc_on), "Turn on power to OF inclinometers", GR_POWER},
    {COMMAND(of_inc_off), "Turn off power to OF inclinometers", GR_POWER},
    ...
    // IF PBOB
    {COMMAND(rfsoc1_on), "Turn on power to rfsoc 1", GR_POWER},
    {COMMAND(rfsoc1_off), "Turn off power to rfsoc 1", GR_POWER},
    {COMMAND(sc1_on), "Turn on power to star camera 1", GR_POWER},
    {COMMAND(sc1_off), "Turn off power to star camera 1", GR_POWER},
    {COMMAND(tauhk_on), "Turn on power to tauHK", GR_POWER},
    {COMMAND(tauhk_off), "Turn off power to tauHK", GR_POWER},
    {COMMAND(gyros_on), "Turn on power to gyroscopes", GR_POWER},
    {COMMAND(gyros_off), "Turn off power to gyroscopes", GR_POWER},
    {COMMAND(rfsoc2_on), "Turn on power to rfsoc 2", GR_POWER},
    {COMMAND(rfsoc2_off), "Turn off power to rfsoc 2", GR_POWER},
    {COMMAND(if_inc_on), "Turn on power to IF inclinometers", GR_POWER},
    {COMMAND(if_inc_off), "Turn off power to IF inclinometers", GR_POWER},
    {COMMAND(sc2_on), "Turn on power to star camera 2", GR_POWER},
    {COMMAND(sc2_off), "Turn off power to star camera 2", GR_POWER},
    {COMMAND(act_bus_on), "Turn on power to stepper daisy chain", GR_POWER},
    {COMMAND(act_bus_off), "Turn off power to stepper daisy chain", GR_POWER},
