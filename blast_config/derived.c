...
derived_tng_t derived_list[] = {
    ...
    LINTERP("Therm_T_unused_13", "Therm13_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    ...
    LINTERP("Therm_T_5way_port_between", "Therm37_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_5way_star_between", "Therm38_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    ...
    LINTERP("Therm_T_unused_47", "Therm47_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_pbob1_gondola", "Therm48_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_pbob1_vicors", "Therm49_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_watchdog", "Therm50_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_pbob2_gondola", "Therm51_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_52", "Therm52_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_pbob2_vicors", "Therm53_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_pbob2_relays", "Therm54_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_55", "Therm55_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    ...
    LINTERP("Therm_T_hdd_pv1", "Therm70_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_hdd_pv2", "Therm71_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
