...
typedef struct {
    ...
    int32_t diode_lw_lna_enabled_chop;
    int32_t diode_lw_lna_enabled_dc;
    int32_t diode_mag_shd_body_enabled_chop;
    int32_t diode_mag_shd_body_enabled_dc;
    int32_t diode_offner_rly_enabled_chop;
    int32_t diode_offner_rly_enabled_dc;
    ...
    int32_t htr_4k_plt_dac;
    int32_t htr_4k_plt_overcurrent_monitor;
    int32_t htr_4k_plt_pwm;
    float htr_4k_plt_volts;
    ...
    int32_t rtd_lw_det_pkg_logdac;
    int32_t rtd_lw_filt_logdac;
    int32_t rtd_lw_fpu_1k_logdac;
    int32_t rtd_lw_fpu_250_logdac;
    int32_t rtd_lw_fpu_350_logdac;
    int32_t rtd_lw_mag_shd_cone_logdac;
    int32_t rtd_uc_head_logdac;
    int32_t tank_pres_mks_902_enabled_chop;
    int32_t tank_pres_mks_902_enabled_dc;
    int32_t vv_pres_mks_902b_enabled_chop;
    int32_t vv_pres_mks_902b_enabled_dc;
} HKDataOne;
...
typedef struct {
    ...
    int32_t diode_lw_lna_code;
    float diode_lw_lna_temperature;
    float diode_lw_lna_voltage;
    int32_t diode_mag_shd_body_code;
    float diode_mag_shd_body_temperature;
    float diode_mag_shd_body_voltage;
    int32_t diode_offner_rly_code;
    float diode_offner_rly_temperature;
    float diode_offner_rly_voltage;
    ...
    int32_t htr_4k_plt_code;
    float htr_4k_plt_current;
    int32_t htr_4k_plt_overcurrent;
    float htr_4k_plt_resistance;
    float htr_4k_plt_voltage;
    ...
    int32_t tank_pres_mks_902_code;
    float tank_pres_mks_902_temperature;
    float tank_pres_mks_902_voltage;
    int32_t vv_pres_mks_902b_code;
    float vv_pres_mks_902b_temperature;
    float vv_pres_mks_902b_voltage;
} HKDataTwenty;
...
typedef struct {
    ...
    int32_t rtd_lw_det_pkg_code;
    float rtd_lw_det_pkg_resistance;
    float rtd_lw_det_pkg_temperature;
    float rtd_lw_det_pkg_voltage;
    ...
    int32_t rtd_lw_mag_shd_cone_code;
    float rtd_lw_mag_shd_cone_resistance;
    float rtd_lw_mag_shd_cone_temperature;
    float rtd_lw_mag_shd_cone_voltage;
