...
derived_tng_t derived_list[] = {
    ...
    LINTERP("Therm_T_sc2_comp", "Therm10_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sc2_lens", "Therm11_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sc2_ccd", "Therm12_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    ...
    LINTERP("Therm_T_sc2_box", "Therm15_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sc1_comp", "Therm16_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sc1_lens", "Therm17_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sc1_ccd", "Therm18_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_unused_19", "Therm19_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
    LINTERP("Therm_T_sc1_box", "Therm20_R", LUT_DIR "thermistor_R_to_T_TIM.lut"),
