...
void udp_receive_cryo_hk_1Hz(void *arg) {
    ...
    while (1) {
        ...
        if (n != sizeof(HKDataOne)) {
            blast_err("Received packet wrong size: %zd bytes", n);
            continue; // retry on error
        }
...
void set_channels_cryo_hk_1Hz(void) {
    ...
    static channel_t *diode_cbob_enabled_chop_Addr;
    static channel_t *diode_cbob_enabled_dc_Addr;
    static channel_t *diode_cop_stop_enabled_chop_Addr;
    static channel_t *diode_cop_stop_enabled_dc_Addr;
    static channel_t *diode_fridge_enabled_chop_Addr;
    static channel_t *diode_fridge_enabled_dc_Addr;
    static channel_t *diode_hawkeye_enabled_chop_Addr;
    static channel_t *diode_hawkeye_enabled_dc_Addr;
    ...
    static channel_t *htr_lw_250_dac_Addr;
    ...
    if (InCharge) {
        if (first_time) {
            ...
            diode_cbob_enabled_chop_Addr = channels_find_by_name("diode_cbob_enabled_chop");
            diode_cbob_enabled_dc_Addr = channels_find_by_name("diode_cbob_enabled_dc");
            diode_cop_stop_enabled_chop_Addr = channels_find_by_name("diode_cop_stop_enabled_chop");
            diode_cop_stop_enabled_dc_Addr = channels_find_by_name("diode_cop_stop_enabled_dc");
            diode_fridge_enabled_chop_Addr = channels_find_by_name("diode_fridge_enabled_chop");
            diode_fridge_enabled_dc_Addr = channels_find_by_name("diode_fridge_enabled_dc");
            diode_hawkeye_enabled_chop_Addr = channels_find_by_name("diode_hawkeye_enabled_chop");
            diode_hawkeye_enabled_dc_Addr = channels_find_by_name("diode_hawkeye_enabled_dc");
            ...
            htr_lw_250_dac_Addr = channels_find_by_name("htr_lw_250_dac");
        ...
        SET_SCALED_VALUE(diode_cbob_enabled_chop_Addr, hk_data_one.diode_cbob_enabled_chop);
        SET_SCALED_VALUE(diode_cbob_enabled_dc_Addr, hk_data_one.diode_cbob_enabled_dc);
        SET_SCALED_VALUE(diode_cop_stop_enabled_chop_Addr, hk_data_one.diode_cop_stop_enabled_chop);
        SET_SCALED_VALUE(diode_cop_stop_enabled_dc_Addr, hk_data_one.diode_cop_stop_enabled_dc);
        SET_SCALED_VALUE(diode_fridge_enabled_chop_Addr, hk_data_one.diode_fridge_enabled_chop);
        SET_SCALED_VALUE(diode_fridge_enabled_dc_Addr, hk_data_one.diode_fridge_enabled_dc);
        SET_SCALED_VALUE(diode_hawkeye_enabled_chop_Addr, hk_data_one.diode_hawkeye_enabled_chop);
        SET_SCALED_VALUE(diode_hawkeye_enabled_dc_Addr, hk_data_one.diode_hawkeye_enabled_dc);
        ...
        SET_SCALED_VALUE(htr_lw_250_dac_Addr, hk_data_one.htr_lw_250_dac);
...
void set_channels_cryo_hk_20Hz(void) {
    ...
    static channel_t *diode_4he_film_temperature_Addr;
    static channel_t *diode_4he_film_voltage_Addr;
    static channel_t *diode_4he_hsw_code_Addr;
    static channel_t *diode_4he_hsw_temperature_Addr;
    static channel_t *diode_4he_hsw_voltage_Addr;
    static channel_t *diode_4he_pump_code_Addr;
    static channel_t *diode_4he_pump_temperature_Addr;
    static channel_t *diode_4he_pump_voltage_Addr;
    static channel_t *diode_4k_filt_code_Addr;
    static channel_t *diode_4k_filt_temperature_Addr;
    static channel_t *diode_4k_filt_voltage_Addr;
    static channel_t *diode_4k_plate_code_Addr;
    static channel_t *diode_4k_plate_temperature_Addr;
    static channel_t *diode_4k_plate_voltage_Addr;
    static channel_t *diode_4k_shield_code_Addr;
    static channel_t *diode_4k_shield_temperature_Addr;
    static channel_t *diode_4k_shield_voltage_Addr;
    static channel_t *diode_cbob_code_Addr;
    static channel_t *diode_cbob_temperature_Addr;
    static channel_t *diode_cbob_voltage_Addr;
    static channel_t *diode_cop_stop_code_Addr;
    static channel_t *diode_cop_stop_temperature_Addr;
    static channel_t *diode_cop_stop_voltage_Addr;
    static channel_t *diode_fridge_code_Addr;
    static channel_t *diode_fridge_temperature_Addr;
    static channel_t *diode_fridge_voltage_Addr;
    static channel_t *diode_hawkeye_code_Addr;
    static channel_t *diode_hawkeye_temperature_Addr;
    static channel_t *diode_hawkeye_voltage_Addr;
    static channel_t *diode_ic_hsw_code_Addr;
    static channel_t *diode_ic_hsw_temperature_Addr;
    ...
    static channel_t *htr_lw_250_code_Addr;
    static channel_t *htr_lw_250_current_Addr;
    ...
    if (InCharge) {
        if (first_time) {
            ...
            diode_4he_film_temperature_Addr = channels_find_by_name("diode_4he_film_temperature");
            ...
            diode_4he_hsw_temperature_Addr = channels_find_by_name("diode_4he_hsw_temperature");
            ...
            diode_4he_pump_temperature_Addr = channels_find_by_name("diode_4he_pump_temperature");
            ...
            diode_4k_filt_temperature_Addr = channels_find_by_name("diode_4k_filt_temperature");
            ...
            diode_4k_plate_temperature_Addr = channels_find_by_name("diode_4k_plate_temperature");
            ...
            diode_4k_shield_temperature_Addr = channels_find_by_name("diode_4k_shield_temperature");
            diode_4k_shield_voltage_Addr = channels_find_by_name("diode_4k_shield_voltage");
            diode_cbob_code_Addr = channels_find_by_name("diode_cbob_code");
            diode_cbob_temperature_Addr = channels_find_by_name("diode_cbob_temperature");
            diode_cbob_voltage_Addr = channels_find_by_name("diode_cbob_voltage");
            diode_cop_stop_code_Addr = channels_find_by_name("diode_cop_stop_code");
            diode_cop_stop_temperature_Addr = channels_find_by_name("diode_cop_stop_temperature");
            diode_cop_stop_voltage_Addr = channels_find_by_name("diode_cop_stop_voltage");
            diode_fridge_code_Addr = channels_find_by_name("diode_fridge_code");
            diode_fridge_temperature_Addr = channels_find_by_name("diode_fridge_temperature");
            diode_fridge_voltage_Addr = channels_find_by_name("diode_fridge_voltage");
            diode_hawkeye_code_Addr = channels_find_by_name("diode_hawkeye_code");
            diode_hawkeye_temperature_Addr = channels_find_by_name("diode_hawkeye_temperature");
            diode_hawkeye_voltage_Addr = channels_find_by_name("diode_hawkeye_voltage");
            diode_ic_hsw_code_Addr = channels_find_by_name("diode_ic_hsw_code");
            diode_ic_hsw_temperature_Addr = channels_find_by_name("diode_ic_hsw_temperature");
            ...
            diode_uc_pump_temperature_Addr = channels_find_by_name("diode_uc_pump_temperature");
            ...
            diode_vcs1_filt_temperature_Addr = channels_find_by_name("diode_vcs1_filt_temperature");
            ...
            diode_vcs1_hex_temperature_Addr = channels_find_by_name("diode_vcs1_hex_temperature");
            ...
            diode_vcs1_top_temperature_Addr = channels_find_by_name("diode_vcs1_top_temperature");
            ...
            diode_vcs2_filt_temperature_Addr = channels_find_by_name("diode_vcs2_filt_temperature");
            ...
            diode_vcs2_hex_temperature_Addr = channels_find_by_name("diode_vcs2_hex_temperature");
            ...
            diode_vcs2_top_temperature_Addr = channels_find_by_name("diode_vcs2_top_temperature");
            ...
            htr_lw_250_code_Addr = channels_find_by_name("htr_lw_250_code");
            htr_lw_250_current_Addr = channels_find_by_name("htr_lw_250_current");
        ...
        SET_SCALED_VALUE(diode_4he_film_temperature_Addr, hk_data_twenty.diode_4he_film_temperature);
        ...
        SET_SCALED_VALUE(diode_4he_hsw_temperature_Addr, hk_data_twenty.diode_4he_hsw_temperature);
        ...
        SET_SCALED_VALUE(diode_4he_pump_temperature_Addr, hk_data_twenty.diode_4he_pump_temperature);
        ...
        SET_SCALED_VALUE(diode_4k_filt_temperature_Addr, hk_data_twenty.diode_4k_filt_temperature);
        ...
        SET_SCALED_VALUE(diode_4k_plate_temperature_Addr, hk_data_twenty.diode_4k_plate_temperature);
        ...
        SET_SCALED_VALUE(diode_4k_shield_temperature_Addr, hk_data_twenty.diode_4k_shield_temperature);
        SET_SCALED_VALUE(diode_4k_shield_voltage_Addr, hk_data_twenty.diode_4k_shield_voltage);
        SET_SCALED_VALUE(diode_cbob_code_Addr, hk_data_twenty.diode_cbob_code);
        SET_SCALED_VALUE(diode_cbob_temperature_Addr, hk_data_twenty.diode_cbob_temperature);
        SET_SCALED_VALUE(diode_cbob_voltage_Addr, hk_data_twenty.diode_cbob_voltage);
        SET_SCALED_VALUE(diode_cop_stop_code_Addr, hk_data_twenty.diode_cop_stop_code);
        SET_SCALED_VALUE(diode_cop_stop_temperature_Addr, hk_data_twenty.diode_cop_stop_temperature);
        SET_SCALED_VALUE(diode_cop_stop_voltage_Addr, hk_data_twenty.diode_cop_stop_voltage);
        SET_SCALED_VALUE(diode_fridge_code_Addr, hk_data_twenty.diode_fridge_code);
        SET_SCALED_VALUE(diode_fridge_temperature_Addr, hk_data_twenty.diode_fridge_temperature);
        SET_SCALED_VALUE(diode_fridge_voltage_Addr, hk_data_twenty.diode_fridge_voltage);
        SET_SCALED_VALUE(diode_hawkeye_code_Addr, hk_data_twenty.diode_hawkeye_code);
        SET_SCALED_VALUE(diode_hawkeye_temperature_Addr, hk_data_twenty.diode_hawkeye_temperature);
        SET_SCALED_VALUE(diode_hawkeye_voltage_Addr, hk_data_twenty.diode_hawkeye_voltage);
        SET_SCALED_VALUE(diode_ic_hsw_code_Addr, hk_data_twenty.diode_ic_hsw_code);
        SET_SCALED_VALUE(diode_ic_hsw_temperature_Addr, hk_data_twenty.diode_ic_hsw_temperature);
        ...
        SET_SCALED_VALUE(diode_uc_pump_temperature_Addr, hk_data_twenty.diode_uc_pump_temperature);
        ...
        SET_SCALED_VALUE(diode_vcs1_filt_temperature_Addr, hk_data_twenty.diode_vcs1_filt_temperature);
        ...
        SET_SCALED_VALUE(diode_vcs1_hex_temperature_Addr, hk_data_twenty.diode_vcs1_hex_temperature);
        ...
        SET_SCALED_VALUE(diode_vcs1_top_temperature_Addr, hk_data_twenty.diode_vcs1_top_temperature);
        ...
        SET_SCALED_VALUE(diode_vcs2_filt_temperature_Addr, hk_data_twenty.diode_vcs2_filt_temperature);
        ...
        SET_SCALED_VALUE(diode_vcs2_hex_temperature_Addr, hk_data_twenty.diode_vcs2_hex_temperature);
        ...
        SET_SCALED_VALUE(diode_vcs2_top_temperature_Addr, hk_data_twenty.diode_vcs2_top_temperature);
        ...
        SET_SCALED_VALUE(htr_lw_250_code_Addr, hk_data_twenty.htr_lw_250_code);
        SET_SCALED_VALUE(htr_lw_250_current_Addr, hk_data_twenty.htr_lw_250_current);
...
void set_channels_cryo_hk_80Hz(void) {
    ...
    static channel_t *rtd_4he_head_temperature_Addr;
    ...
    static channel_t *rtd_ic_head_temperature_Addr;
    static channel_t *rtd_ic_head_voltage_Addr;
    static channel_t *rtd_lw_250_fin_code_Addr;
    ...
    static channel_t *rtd_lw_filt_voltage_Addr;
    static channel_t *rtd_lw_fpu_1k_code_Addr;
    static channel_t *rtd_lw_fpu_1k_resistance_Addr;
    static channel_t *rtd_lw_fpu_1k_temperature_Addr;
    ...
    static channel_t *rtd_lw_fpu_250_temperature_Addr;
    ...
    if (InCharge) {
        if (first_time) {
            ...
            rtd_1_3_temperature_Addr = channels_find_by_name("rtd_1_3_temperature");
            ...
            rtd_1_4_temperature_Addr = channels_find_by_name("rtd_1_4_temperature");
            ...
            rtd_1_5_temperature_Addr = channels_find_by_name("rtd_1_5_temperature");
            ...
            rtd_1_6_temperature_Addr = channels_find_by_name("rtd_1_6_temperature");
            ...
            rtd_1_7_temperature_Addr = channels_find_by_name("rtd_1_7_temperature");
            ...
            rtd_4he_head_temperature_Addr = channels_find_by_name("rtd_4he_head_temperature");
            ...
            rtd_ic_head_temperature_Addr = channels_find_by_name("rtd_ic_head_temperature");
            rtd_ic_head_voltage_Addr = channels_find_by_name("rtd_ic_head_voltage");
            rtd_lw_250_fin_code_Addr = channels_find_by_name("rtd_lw_250_fin_code");
            ...
            rtd_lw_filt_voltage_Addr = channels_find_by_name("rtd_lw_filt_voltage");
            ...
            rtd_lw_fpu_1k_temperature_Addr = channels_find_by_name("rtd_lw_fpu_1k_temperature");
            ...
            rtd_lw_fpu_250_temperature_Addr = channels_find_by_name("rtd_lw_fpu_250_temperature");
        ...
        SET_SCALED_VALUE(rtd_1_3_temperature_Addr, hk_data_eighty.rtd_1_3_temperature);
        ...
        SET_SCALED_VALUE(rtd_1_4_temperature_Addr, hk_data_eighty.rtd_1_4_temperature);
        ...
        SET_SCALED_VALUE(rtd_1_5_temperature_Addr, hk_data_eighty.rtd_1_5_temperature);
        ...
        SET_SCALED_VALUE(rtd_1_6_temperature_Addr, hk_data_eighty.rtd_1_6_temperature);
        ...
        SET_SCALED_VALUE(rtd_1_7_temperature_Addr, hk_data_eighty.rtd_1_7_temperature);
        ...
        SET_SCALED_VALUE(rtd_4he_head_temperature_Addr, hk_data_eighty.rtd_4he_head_temperature);
        ...
        SET_SCALED_VALUE(rtd_ic_head_temperature_Addr, hk_data_eighty.rtd_ic_head_temperature);
        SET_SCALED_VALUE(rtd_ic_head_voltage_Addr, hk_data_eighty.rtd_ic_head_voltage);
        SET_SCALED_VALUE(rtd_lw_250_fin_code_Addr, hk_data_eighty.rtd_lw_250_fin_code);
        ...
        SET_SCALED_VALUE(rtd_lw_filt_voltage_Addr, hk_data_eighty.rtd_lw_filt_voltage);
        ...
        SET_SCALED_VALUE(rtd_lw_fpu_1k_temperature_Addr, hk_data_eighty.rtd_lw_fpu_1k_temperature);
        ...
        SET_SCALED_VALUE(rtd_lw_fpu_250_temperature_Addr, hk_data_eighty.rtd_lw_fpu_250_temperature);
