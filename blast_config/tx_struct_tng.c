...
// flag for maybe deprecated
    ...
    // this actbus SF stuff is maybe deprecated? idk what uses it and it doesnt get downlinked
...
// flag for deprecated but requires precision removal
