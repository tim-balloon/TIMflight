...
channel_t channel_list[] =
{
    ...
    // Gondola thermometry
    { "themistor_1",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_2",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_3",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_4",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_5",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_6",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_7",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_8",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_9",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_10",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_11",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_12",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_13",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_14",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_15",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_16",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_17",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_18",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_19",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_20",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_21",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_22",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_23",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_24",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_25",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_26",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_27",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_28",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_29",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_30",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_31",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_32",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_33",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_34",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_35",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_36",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_37",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_38",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_39",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_40",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_41",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_42",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_43",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_44",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_45",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_46",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_47",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_48",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_49",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_50",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_51",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_52",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_53",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_54",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_55",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_56",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_57",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_58",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_59",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_60",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_61",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_62",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_63",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_64",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_65",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_66",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_67",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_68",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_69",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_70",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_71",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_72",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_73",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_74",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_75",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_76",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_77",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_78",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_79",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_80",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_81",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_82",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_83",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "themistor_84",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
