...
channel_t channel_list[] =
{
    ...
    { "current_acomp_box",                 SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_motor_eth", SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_magnetometer",          SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    ...
    { "current_rfsoc_1",  SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_sc1",  SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_tauhk",  SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_gyros",  SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_rfsoc_2",  SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_inclinometer",  SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    ...
    // Motor PBOB
    { "current_motor_1",          SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_el_mc",          SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_rw_mc",         SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_pivot_mc", SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_hdd",      SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_pss",            SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_starlink",        SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_motor_relay_8",            SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_motor_relay_9",           SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    { "current_motor_relay_10",       SCALE(LABJACK), TYPE_UINT16, RATE_1HZ, U_V_V, 0 },
    // Voltage monitoring
    ...
    {"sc1_gain_fact",                    SCALE(CONVERT_UNITY), TYPE_DOUBLE, RATE_1HZ, U_NONE, 0},
    ...
    {"sc2_gain_fact",                    SCALE(CONVERT_UNITY), TYPE_DOUBLE, RATE_1HZ, U_NONE, 0},
    ...
    { "diode_4k_filt_enabled_chop", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_4k_filt_enabled_dc", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    ...
    { "diode_cbob_enabled_chop", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_cbob_enabled_dc", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_cop_stop_enabled_chop", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_cop_stop_enabled_dc", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_fridge_enabled_chop", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_fridge_enabled_dc", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_hawkeye_enabled_chop", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_hawkeye_enabled_dc", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    ...
    { "diode_lw_coll_enabled_chop", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_lw_coll_enabled_dc", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_lw_lna_enabled_chop", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_lw_lna_enabled_dc", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_mag_shd_body_enabled_chop", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_mag_shd_body_enabled_dc", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_offner_rly_enabled_chop", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_offner_rly_enabled_dc", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    ...
    { "diode_vcs1_filt_enabled_chop", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_vcs1_filt_enabled_dc", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    ...
    { "diode_vcs1_top_enabled_chop", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_vcs1_top_enabled_dc", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_vcs2_filt_enabled_chop", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_vcs2_filt_enabled_dc", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    ...
    { "diode_vcs2_top_enabled_chop", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_vcs2_top_enabled_dc", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "global_cryoheater_enable", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_4he_hsw_dac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_4he_hsw_overcurrent_monitor", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_4he_hsw_pwm", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_4he_hsw_volts", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_1HZ, U_NONE, 0 },
    { "htr_4he_pmp_dac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_4he_pmp_overcurrent_monitor", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_4he_pmp_pwm", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_4he_pmp_volts", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_1HZ, U_NONE, 0 },
    { "htr_4k_plt_dac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_4k_plt_overcurrent_monitor", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_4k_plt_pwm", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_4k_plt_volts", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_1HZ, U_NONE, 0 },
    { "htr_ic_hsw_dac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_ic_hsw_overcurrent_monitor", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_ic_hsw_pwm", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_ic_hsw_volts", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_1HZ, U_NONE, 0 },
    { "htr_ic_pump_dac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_ic_pump_overcurrent_monitor", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_ic_pump_pwm", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_ic_pump_volts", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_1HZ, U_NONE, 0 },
    { "htr_lw_250_dac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_lw_250_overcurrent_monitor", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_lw_250_pwm", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_lw_250_volts", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_1HZ, U_NONE, 0 },
    { "htr_uc_hsw_dac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_uc_hsw_overcurrent_monitor", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_uc_hsw_pwm", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_uc_hsw_volts", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_1HZ, U_NONE, 0 },
    { "htr_uc_pump_dac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_uc_pump_overcurrent_monitor", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_uc_pump_pwm", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_uc_pump_volts", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_1HZ, U_NONE, 0 },
    { "htr_vcs1_dac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_vcs1_overcurrent_monitor", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_vcs1_pwm", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_vcs1_volts", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_1HZ, U_NONE, 0 },
    { "htr_vcs2_dac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_vcs2_overcurrent_monitor", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_vcs2_pwm", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "htr_vcs2_volts", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_1HZ, U_NONE, 0 },
    { "rtd_1_2_logdac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "rtd_1_3_logdac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "rtd_1_4_logdac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "rtd_1_5_logdac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "rtd_1_6_logdac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "rtd_1_7_logdac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    ...
    { "rtd_lw_250_fin_logdac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "rtd_lw_det_pkg_logdac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "rtd_lw_filt_logdac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    ...
    { "rtd_lw_mag_shd_cone_logdac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "rtd_uc_head_logdac", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "tank_pres_mks_902_enabled_chop", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "tank_pres_mks_902_enabled_dc", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "vv_pres_mks_902b_enabled_chop", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "vv_pres_mks_902b_enabled_dc", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_1HZ, U_NONE, 0 },
    { "diode_4he_film_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_4he_film_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_4he_film_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_4he_hsw_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_4he_hsw_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    ...
    { "diode_4he_pump_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_4he_pump_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_4k_filt_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_4k_filt_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_4k_filt_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_4k_plate_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_4k_plate_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    ...
    { "diode_4k_shield_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_4k_shield_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_cbob_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_cbob_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_cbob_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_cop_stop_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_cop_stop_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_cop_stop_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_fridge_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_fridge_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_fridge_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_hawkeye_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_hawkeye_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_hawkeye_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_ic_hsw_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_ic_hsw_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    ...
    { "diode_ic_pump_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_ic_pump_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_lw_coll_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_lw_coll_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_lw_coll_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_lw_lna_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_lw_lna_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_lw_lna_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_mag_shd_body_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_mag_shd_body_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_mag_shd_body_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_offner_rly_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_offner_rly_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_offner_rly_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_uc_hsw_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_uc_hsw_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    ...
    { "diode_uc_pump_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_uc_pump_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs1_filt_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs1_filt_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs1_filt_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs1_hex_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs1_hex_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs1_hex_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs1_top_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs1_top_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs1_top_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs2_filt_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs2_filt_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs2_filt_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs2_hex_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs2_hex_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs2_hex_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs2_top_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs2_top_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "diode_vcs2_top_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_4he_hsw_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_4he_hsw_current", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_4he_hsw_overcurrent", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_4he_hsw_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_4he_hsw_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_4he_pmp_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_4he_pmp_current", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_4he_pmp_overcurrent", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_4he_pmp_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_4he_pmp_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_4k_plt_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_4k_plt_current", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_4k_plt_overcurrent", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_4k_plt_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_4k_plt_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_ic_hsw_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_ic_hsw_current", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_ic_hsw_overcurrent", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_ic_hsw_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_ic_hsw_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_ic_pump_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_ic_pump_current", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_ic_pump_overcurrent", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_ic_pump_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_ic_pump_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_lw_250_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_lw_250_current", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_lw_250_overcurrent", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_lw_250_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_lw_250_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_uc_hsw_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_uc_hsw_current", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_uc_hsw_overcurrent", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_uc_hsw_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_uc_hsw_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_uc_pump_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_uc_pump_current", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_uc_pump_overcurrent", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_uc_pump_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_uc_pump_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_vcs1_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_vcs1_current", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_vcs1_overcurrent", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_vcs1_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_vcs1_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_vcs2_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_vcs2_current", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_vcs2_overcurrent", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "htr_vcs2_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "htr_vcs2_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "tank_pres_mks_902_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "tank_pres_mks_902_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "tank_pres_mks_902_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "vv_pres_mks_902b_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_20HZ, U_NONE, 0 },
    { "vv_pres_mks_902b_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "vv_pres_mks_902b_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_20HZ, U_NONE, 0 },
    { "rtd_1_2_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_2_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_2_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_2_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_3_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_3_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_3_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_3_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_4_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_4_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_4_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_4_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_5_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_5_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_5_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_5_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_6_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_6_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_6_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_6_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_7_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_7_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_7_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_1_7_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    ...
    { "rtd_4he_head_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    ...
    { "rtd_ic_head_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_ic_head_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_250_fin_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_250_fin_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_250_fin_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_250_fin_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_det_pkg_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_det_pkg_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_det_pkg_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_det_pkg_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_filt_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_filt_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_filt_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_filt_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    ...
    { "rtd_lw_fpu_1k_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    ...
    { "rtd_lw_fpu_250_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    ...
    { "rtd_lw_fpu_350_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_fpu_350_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_mag_shd_cone_code", SCALE(CONVERT_UNITY), TYPE_INT32, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_mag_shd_cone_resistance", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_mag_shd_cone_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    { "rtd_lw_mag_shd_cone_voltage", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
    ...
    { "rtd_uc_head_temperature", SCALE(CONVERT_UNITY), TYPE_FLOAT, RATE_80HZ, U_NONE, 0 },
